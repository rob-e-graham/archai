# ARCHAI IP Provenance

**Author:** Rob Graham
**Affiliations:**
- FAMTEC (Fine Art Media Tech)
- RMIT University

**Project:** ARCHAI — Augmented Reanimation, Cultural Heritage, Artificial Intelligence

**Status:** Active doctoral research project, software platform, and research programme.
...
- Publications
- Presentations
- Academic supervision records
- Public demonstrations

## Current Position

ARCHAI is simultaneously:
...
Strongest evidence of ownership and provenance (in order):

1. Git commit history
2. Repository ownership
3. PhD research records
4. Publications
