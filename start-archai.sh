...
check "Frontend"         "http://localhost:8000/ARCHAI_v10_6.html"
...
echo ""
echo -e "  ${CYAN}Local:${NC}     http://localhost:8000/ARCHAI_v10_6.html"
echo -e "  ${CYAN}Tailscale:${NC} http://${TAILSCALE_IP}:8000/ARCHAI_v10_6.html"
